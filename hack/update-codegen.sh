...
OUTPUT_PKG=github.com/identitatem/idp-mgmt-operator/api/client
FQ_APIS=github.com/identitatem/idp-mgmt-operator/api/authrealm/v1
APIS_PKG=github.com/identitatem/idp-mgmt-operator/api
...
COMMON_FLAGS="${VERIFY_FLAG:-} --go-header-file ${SCRIPT_ROOT}/hack/boilerplate.go.txt ${COMMON_FLAGS}"
