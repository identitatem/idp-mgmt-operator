...
func (in *AuthRealmSpec) DeepCopyInto(out *AuthRealmSpec) {
	*out = *in
	if in.Placement != nil {
		...
		*out = new(clusterv1alpha1.Placement)
		(*in).DeepCopyInto(*out)
	}
	if in.AuthProxy != nil {
...
func (in *IdentityProviderSpec) DeepCopyInto(out *IdentityProviderSpec) {
	*out = *in
	if in.GitHub != nil {
		...
		*out = new(configv1.GitHubIdentityProvider)
		(*in).DeepCopyInto(*out)
	}
	if in.Google != nil {
		in, out := &in.Google, &out.Google
		*out = new(configv1.GoogleIdentityProvider)
		**out = **in
	}
	if in.HTPasswd != nil {
		in, out := &in.HTPasswd, &out.HTPasswd
		*out = new(configv1.HTPasswdIdentityProvider)
		**out = **in
	}
	if in.LDAP != nil {
		in, out := &in.LDAP, &out.LDAP
		*out = new(configv1.LDAPIdentityProvider)
		(*in).DeepCopyInto(*out)
	}
	if in.OpenID != nil {
		in, out := &in.OpenID, &out.OpenID
		*out = new(configv1.OpenIDIdentityProvider)
		(*in).DeepCopyInto(*out)
	}
}
